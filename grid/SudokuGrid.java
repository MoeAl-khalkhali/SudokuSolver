...
public abstract class SudokuGrid
{
	...
	public abstract NodeCo[] getCollection();
     ...
     */
    public abstract boolean validate(int i, int j, NodeCo next);
    public abstract boolean validate();
    public abstract boolean validatePartial();

    public abstract int[][] getGrid();
    
    public abstract void setGrid(int[][] arr);
